        ...
        <table class="basic_table" style="color:#121212">
            ...
            %for line in o.invoice_line:
                ...
                %else:
                    <tr>
                %endif
                    <!-- 22/12/2015 (felix) Agregar campos:
                        Código, Product, Especificacion, Pedimento, Aduana
                        Fecha, Lote y Caducidad
                    -->
                    <td class="basic_td">${line.name or ''|entity}<br />
                        ${_("Código: ")}${line.prod_cli_id.codigo_prod or ''}<br />
                        ${_("Producto: ")}${line.prod_cli_id.name or ''}<br />
                        ${_("Especificación: ")}${line.prod_cli_id.especificacion or ''}<br />
                        
                        <!--
                        ${_("Pedimento: ")}${line.prod_cli_id.especificacion or ''}<br />
                        ${_("Aduana: ")}${line.prod_cli_id.especificacion or ''}<br />
                        ${_("Fecha: ")}${line.prod_cli_id.especificacion or ''}<br />
                        ${_("Lote: ")}${line.prod_cli_id.especificacion or ''}<br />
                        ${_("Caducidad: ")}${line.prod_cli_id.especificacion or ''}<br />-->
                    </td>
